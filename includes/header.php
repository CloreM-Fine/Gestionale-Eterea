    ...
    <aside id="sidebar" class="mobile-menu fixed left-0 top-0 h-full bg-slate-800 text-white z-50 flex flex-col lg:translate-x-0 sidebar-collapsed">
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            <ul class="space-y-1 px-2">
                ...
                <li>
                    <a href="listini.php" 
                       class="flex items-center gap-3 px-3 py-3 rounded-lg transition-colors <?php echo $currentPage === 'listini' ? 'bg-cyan-600 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white'; ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/>
                        </svg>
                        <span class="sidebar-text">Listini</span>
                    </a>
                </li>
                <li>
