...
<div class="md:col-span-2 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
    <div class="p-5 border-b border-slate-100">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="font-semibold text-slate-800">Report e Analisi</h3>
                    <p class="text-xs sm:text-sm text-slate-500">Statistiche dettagliate del team</p>
                </div>
            </div>
    ...
    <div class="border-b border-slate-200 overflow-x-auto">
        <div class="flex min-w-max">
            <button onclick="switchReportTab('dashboard')" id="tab-dashboard" class="report-tab active px-6 py-3 text-sm font-medium border-b-2 border-indigo-500 text-indigo-600 bg-indigo-50/50">
                Dashboard
            </button>
            <button onclick="switchReportTab('utenti')" id="tab-utenti" class="report-tab px-6 py-3 text-sm font-medium border-b-2 border-transparent text-slate-500 hover:text-slate-700">
                Team
            </button>
            <button onclick="switchReportTab('progetti')" id="tab-progetti" class="report-tab px-6 py-3 text-sm font-medium border-b-2 border-transparent text-slate-500 hover:text-slate-700">
                Progetti
            </button>
            <button onclick="switchReportTab('economico')" id="tab-economico" class="report-tab px-6 py-3 text-sm font-medium border-b-2 border-transparent text-slate-500 hover:text-slate-700">
                Economico
            </button>
            <button onclick="switchReportTab('temporale')" id="tab-temporale" class="report-tab px-6 py-3 text-sm font-medium border-b-2 border-transparent text-slate-500 hover:text-slate-700">
                Andamento
            </button>
        </div>
    </div>
    ...
    <div class="p-5">
        ...
        <div id="report-content-dashboard" class="report-content">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl p-4 text-white">
                    ...
                    <div class="text-amber-200 text-xs mt-1">ultimi 30 giorni</div>
                </div>
                <div class="bg-gradient-to-br from-rose-500 to-rose-600 rounded-xl p-4 text-white">
                    <div class="text-rose-100 text-sm mb-1">Costi Totali</div>
                    <div class="text-2xl font-bold" id="kpi-costi-totali">-</div>
                    <div class="text-rose-200 text-xs mt-1">€ generati</div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div class="bg-slate-50 rounded-xl p-4">
                    <h4 class="font-semibold text-slate-700 mb-4">Stato Progetti</h4>
                    <div class="h-64">
        ...
        <div id="report-content-utenti" class="report-content hidden">
            <div class="mb-4 flex flex-col sm:flex-row gap-3">
                <select id="filter-utenti-periodo" onchange="loadUtentiReport()" class="px-3 py-2 border border-slate-200 rounded-lg text-sm">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div class="bg-slate-50 rounded-xl p-4">
                    <h4 class="font-semibold text-slate-700 mb-4">Ore per Membro</h4>
                    <div class="h-64">
                ...
                <table class="w-full text-sm">
                    <thead class="bg-slate-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-center font-medium text-slate-600">Task Assegnate</th>
                            ...
                            <th class="px-4 py-3 text-center font-medium text-slate-600">Ore Lavorate</th>
                            <th class="px-4 py-3 text-right font-medium text-slate-600">Costo Generato</th>
                        </tr>
                    </thead>
                    <tbody id="table-utenti-body" class="divide-y divide-slate-100">
                        <!-- Popolato via JS -->
                    </tbody>
                </table>
            </div>
        ...
        <div id="report-content-progetti" class="report-content hidden">
            <div class="mb-4 flex flex-col sm:flex-row gap-3">
                <select id="filter-progetti-stato" onchange="loadProgettiReport()" class="px-3 py-2 border border-slate-200 rounded-lg text-sm">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div class="bg-slate-50 rounded-xl p-4">
                    <h4 class="font-semibold text-slate-700 mb-4">Budget vs Costi</h4>
                    <div class="h-64">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody id="table-progetti-body" class="divide-y divide-slate-100">
                        <!-- Popolato via JS -->
                    </tbody>
                </table>
            </div>
        ...
        <div id="report-content-economico" class="report-content hidden">
            <div class="mb-4 flex flex-col sm:flex-row gap-3">
                <select id="filter-economico-anno" onchange="loadEconomicoReport()" class="px-3 py-2 border border-slate-200 rounded-lg text-sm">
            ...
            <div class="grid grid-cols-3 gap-4 mb-6">
                <div class="bg-emerald-50 rounded-xl p-4 text-center">
                    <div class="text-emerald-600 text-sm mb-1">Entrate Totali</div>
                    <div class="text-2xl font-bold text-emerald-700" id="eco-entrate">-</div>
                </div>
                <div class="bg-rose-50 rounded-xl p-4 text-center">
                    <div class="text-rose-600 text-sm mb-1">Uscite Totali</div>
                    <div class="text-2xl font-bold text-rose-700" id="eco-uscite">-</div>
                </div>
                <div class="bg-indigo-50 rounded-xl p-4 text-center">
                    <div class="text-indigo-600 text-sm mb-1">Saldo</div>
                    <div class="text-2xl font-bold text-indigo-700" id="eco-saldo">-</div>
                </div>
            </div>
        ...
        <div id="report-content-temporale" class="report-content hidden">
            <div class="mb-4 flex flex-col sm:flex-row gap-3">
                <select id="filter-temporale-mesi" onchange="loadTemporaleReport()" class="px-3 py-2 border border-slate-200 rounded-lg text-sm">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="bg-indigo-50 rounded-xl p-4 text-center">
                    <div class="text-indigo-600 text-3xl font-bold" id="temp-task-totali">-</div>
                    <div class="text-indigo-500 text-sm">Task Completate</div>
                </div>
                <div class="bg-cyan-50 rounded-xl p-4 text-center">
                    <div class="text-cyan-600 text-3xl font-bold" id="temp-ore-totali">-</div>
                    <div class="text-cyan-500 text-sm">Ore Lavorate</div>
                </div>
                <div class="bg-emerald-50 rounded-xl p-4 text-center">
                    <div class="text-emerald-600 text-3xl font-bold" id="temp-progetti-nuovi">-</div>
                    <div class="text-emerald-500 text-sm">Nuovi Progetti</div>
                </div>
            </div>
        </div>
    </div>
...
// ============================================================
// GESTIONE REPORT E ANALISI
// ============================================================

let reportCharts = {};

// Switch tra tab del report
...
async function loadDashboardStats() {
    try {
        ...
        if (data.success) {
            ...
            // KPI
            document.getElementById('kpi-progetti-totali').textContent = stats.progetti.totale;
            document.getElementById('kpi-progetti-attivi').textContent = stats.progetti.in_corso;
            document.getElementById('kpi-task-completate').textContent = stats.task.completate;
            document.getElementById('kpi-task-totali').textContent = stats.task.totale;
            document.getElementById('kpi-ore-lavorate').textContent = stats.tempo.ore;
            document.getElementById('kpi-costi-totali').textContent = '€' + stats.economico.costi_task.toLocaleString('it-IT');
            
            // Chart Progetti Stato
            destroyChart('progetti-stato');
            reportCharts['progetti-stato'] = new Chart(document.getElementById('chart-progetti-stato'), {
                type: 'doughnut',
                data: {
                    labels: ['In Corso', 'Completati', 'Archiviati'],
                    datasets: [{
                        data: [stats.progetti.in_corso, stats.progetti.completati, stats.progetti.archiviati],
            ...
            // Chart Task Stato
            destroyChart('task-stato');
            reportCharts['task-stato'] = new Chart(document.getElementById('chart-task-stato'), {
                type: 'doughnut',
                data: {
                    labels: ['Da Fare', 'In Lavorazione', 'Completate'],
                    datasets: [{
                        data: [stats.task.da_fare, stats.task.in_lavorazione, stats.task.completate],
...
async function loadUtentiReport() {
    ...
    try {
        ...
        if (data.success) {
            ...
            // Chart Ore per Utente
            destroyChart('utenti-ore');
            reportCharts['utenti-ore'] = new Chart(document.getElementById('chart-utenti-ore'), {
                type: 'bar',
                data: {
            ...
            // Chart Efficienza
            destroyChart('utenti-efficienza');
            reportCharts['utenti-efficienza'] = new Chart(document.getElementById('chart-utenti-efficienza'), {
                type: 'bar',
                data: {
                    labels: utenti.map(u => u.nome),
                    datasets: [{
            ...
            // Tabella
            const tbody = document.getElementById('table-utenti-body');
            tbody.innerHTML = utenti.map(u => `
                <tr class="hover:bg-slate-50">
                    <td class="px-4 py-3">
                        <div class="flex items-center gap-2">
                            <div class="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold" style="background-color: ${u.colore}">
                                ${u.nome.charAt(0)}
                            </div>
                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex items-center justify-center gap-2">
                            <div class="w-16 h-2 bg-slate-200 rounded-full overflow-hidden">
                                <div class="h-full ${u.efficienza >= 80 ? 'bg-emerald-500' : u.efficienza >= 50 ? 'bg-amber-500' : 'bg-rose-500'}" style="width: ${u.efficiencia}%"></div>
                            </div>
...
async function loadProgettiReport() {
    ...
    try {
        ...
        if (data.success) {
            ...
            // Chart Budget vs Costi
            destroyChart('progetti-budget');
            reportCharts['progetti-budget'] = new Chart(document.getElementById('chart-progetti-budget'), {
                type: 'bar',
                data: {
                    ...
                    datasets: [
                        {
                            label: 'Budget',
                            data: progetti.slice(0, 8).map(p => p.budget),
                            backgroundColor: '#3b82f6',
                            borderRadius: 4
                        },
                        {
                            label: 'Costo',
                            data: progetti.slice(0, 8).map(p => p.costo_totale),
            ...
            // Chart Avanzamento
            destroyChart('progetti-avanzamento');
            reportCharts['progetti-avanzamento'] = new Chart(document.getElementById('chart-progetti-avanzamento'), {
                type: 'bar',
                data: {
                    labels: progetti.slice(0, 8).map(p => p.titolo.substring(0, 15) + '...'),
                    datasets: [{
            ...
            // Tabella
            const tbody = document.getElementById('table-progetti-body');
            tbody.innerHTML = progetti.map(p => {
                const statoClass = {
                    'in_corso': 'bg-blue-100 text-blue-700',
                    'completato': 'bg-emerald-100 text-emerald-700',
                    'archiviato': 'bg-slate-100 text-slate-700'
                }[p.stato] || 'bg-slate-100 text-slate-700';
                ...
                return `
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <span class="px-2 py-1 rounded-full text-xs font-medium ${statoClass}">${p.stato.replace('_', ' ')}</span>
                        </td>
                        <td class="px-4 py-3 text-center">${p.task_completate}/${p.totale_task}</td>
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-2">
                                <div class="w-16 h-2 bg-slate-200 rounded-full overflow-hidden">
                                    <div class="h-full bg-emerald-500" style="width: ${p.avanzamento}%"></div>
                                </div>
...
async function loadEconomicoReport() {
    ...
    try {
        ...
        if (data.success) {
            ...
            // Riepilogo
            document.getElementById('eco-entrate').textContent = '€' + report.totale.entrate.toLocaleString('it-IT');
            document.getElementById('eco-uscite').textContent = '€' + report.totale.uscite.toLocaleString('it-IT');
            document.getElementById('eco-saldo').textContent = '€' + report.totale.saldo.toLocaleString('it-IT');
            document.getElementById('eco-saldo').className = 'text-2xl font-bold ' + (report.totale.saldo >= 0 ? 'text-emerald-700' : 'text-rose-700');
            
            // Prepara dati mensili (tutti i mesi)
            ...
            report.mensile.forEach(m => {
                entrateData[m.mese - 1] = m.entrate;
                usciteData[m.mese - 1] = m.uscite;
            });
            
            // Chart Mensile
            destroyChart('economico-mensile');
            reportCharts['economico-mensile'] = new Chart(document.getElementById('chart-economico-mensile'), {
                type: 'line',
                data: {
                    labels: mesiLabels,
                    datasets: [
            ...
            // Chart Costi per Progetto
            destroyChart('economico-progetti');
            reportCharts['economico-progetti'] = new Chart(document.getElementById('chart-economico-progetti'), {
                type: 'bar',
                data: {
                    labels: report.costi_progetto.map(p => p.titolo.substring(0, 12) + '...'),
                    datasets: [{
                        label: 'Costo',
                        data: report.costi_progetto.map(p => p.costo_totale),
        ...
        console.error('Errore caricamento economico:', error);
    }
}
...
async function loadTemporaleReport() {
    ...
    try {
        ...
        if (data.success) {
            ...
            // Calcola totali
            const totaliTask = report.task_completate.reduce((a, b) => a + parseInt(b.task_completate), 0);
            const totaliOre = report.ore_lavorate.reduce((a, b) => a + parseFloat(b.ore_lavorate), 0);
            const totaliProgetti = report.nuovi_progetti.reduce((a, b) => a + parseInt(b.nuovi_progetti), 0);
            ...
            // Prepara dati per periodi
            const periodi = [...new Set([
                ...report.task_completate.map(t => t.periodo),
                ...report.ore_lavorate.map(o => o.periodo),
                ...report.nuovi_progetti.map(p => p.periodo)
            ])].sort();
            
            const labels = periodi.map(p => {
                const [anno, mese] = p.split('-');
                return `${mese}/${anno}`;
            });
            
            const taskData = periodi.map(p => {
                const found = report.task_completate.find(t => t.periodo === p);
                return found ? parseInt(found.task_completate) : 0;
            });
            
            const oreData = periodi.map(p => {
                const found = report.ore_lavorate.find(o => o.periodo === p);
                return found ? parseFloat(found.ore_lavorate) : 0;
            });
            
            const progettiData = periodi.map(p => {
                const found = report.nuovi_progetti.find(n => n.periodo === p);
                return found ? parseInt(found.nuovi_progetti) : 0;
            });
            
            // Chart Andamento
            destroyChart('temporale-andamento');
            reportCharts['temporale-andamento'] = new Chart(document.getElementById('chart-temporale-andamento'), {
                type: 'line',
                data: {
                    labels: labels,
                    datasets: [
        ...
        console.error('Errore caricamento temporale:', error);
    }
}

// Helper per distruggere chart esistente
...
document.addEventListener('DOMContentLoaded', function() {
    // Piccolo delay per assicurarsi che Chart.js sia caricato
    setTimeout(() => {
        loadDashboardStats();
    }, 100);
});
